...
var _Calculator = __webpack_require__(28);
...
var _CalculatorGUI = __webpack_require__(29);

var _CalculatorGUI2 = _interopRequireDefault(_CalculatorGUI);
...
var Calculator = function (_Component) {
    ...
    _createClass(Calculator, [{
        ...
        value: function decreasePoints(stat) {
            ...
            if (points > 1) {
                var unusedPoints = this.state.unused;
                var price = this.calculatePrice(points, 0);
                var stats = this.state;
                stats[stat] = points - 1;
                this.setState(_extends({}, stats, {
        ...
        key: "increasePoints",
        value: function increasePoints(stat) {
            var points = this.state[stat];
            var unusedPoints = this.state.unused;
            var price = this.calculatePrice(points, 1);
        ...
        key: "calculatePrice",
        value: function calculatePrice(points, param) {
            return points + param <= 10 ? 1 : points + param <= 14 ? 2 : points + param <= 18 ? 3 : points + param <= 22 ? 4 : 5;
        }
    }, {
        key: "render",
        value: function render() {
...
var stat = function stat(increase, decrease, statName, statPoints) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            "div",
            { className: "calculator-stat-name" },
            statName
        ),
        _react2.default.createElement("div", { className: "calculator-arrow-button calculator-increase-stat", onClick: function onClick() {
                return increase(statName);
            } }),
        _react2.default.createElement(
            "div",
            { className: "calculator-stat-points" },
            statPoints
        ),
        _react2.default.createElement("div", { className: "calculator-arrow-button calculator-decrease-stat", onClick: function onClick() {
                return decrease(statName);
            } })
    );
}; // React
